                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card text-center">
                        <div class="body">
                            ...
                            <span>Nombre total de sites Web</span>
                            <h3 class="m-b-10"><span class="number count-to" data-from="0" data-to="2078" data-speed="2000" data-fresh-interval="700">2</span></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
