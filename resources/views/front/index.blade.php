    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-2 cusLogo">
                <div class="logo">
                    <a href="index.html">
                        <img src="{{asset('front/images/logo.png')}}" alt="Makeover"/>
                    </a>
                </div>
            </div>
                ...
                <nav class="mainMenu">
                    <ul>
                        ...
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                <li><a href="service1.html">Services One</a></li>
                                <li><a href="service2.html">Services Two</a></li>
                        ...
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                <li class="menu-item-has-children">
                                    <a href="javascript:void(0);">Without Sidebar</a>
                                    <ul class="sub-menu">
                                        <li><a href="blog1.html">Grid Style 01</a></li>
                                        <li><a href="blog4.html">Grid Style 02</a></li>
                                        <li><a href="blog5.html">Grid Style 03</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item-has-children">
                                    <a href="javascript:void(0);">With Sidebar</a>
                                    <ul class="sub-menu">
                                        <li><a href="blog2.html">Left Sidebar</a></li>
                                        <li><a href="blog3.html">Right Sidebar</a></li>
                                    </ul>
                                </li>
                        ...
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="package.html">Package Page</a></li>
                                <li><a href="testimonial.html">Testimonial Page</a></li>
                                <li><a href="faq.html">Faq Page</a></li>
                                <li class="menu-item-has-children">
                                    <a href="javascript:void(0);">Gallery Page</a>
                                    <ul class="sub-menu">
                                ...
                                <li class="menu-item-has-children">
                                    <a href="javascript:void(0);">Team Page</a>
                                    <ul class="sub-menu">
    ...
    <div class="widget_area">
        ...
        <div class="center_align">
            <div class="about_widget_area">
                <div class="wd_logo">
                    <a href="index.html"><img src="{{asset('front/images/logo.png')}}" alt="makeover"/></a>
                </div>
                <p>
        ...
        <div id="rev_slider_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.1">
            <ul>
                <li data-index="rs-3046" data-transition="random-premium" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1000"  data-thumb=""  data-rotate="0"  data-saveperformance="off"  data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    ><img src="{{asset('front/images/bg/layer.png')}}" alt="Layer" width="203" height="43"></div>
                    ...
                    ><a href="booking.html" class="mo_btn mob_lg"><i class="icofont-cart-alt"></i>Make Appointment</a>
                    </div>
                    ...
                    ><img src="{{asset('front/images/home_01/layer.png')}}" alt="App Store"></div>
                    ...
                    ><img src="{{asset('front/images/bg/page_layer.png')}}" alt="App Store"></div>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="sectionTitle text-center">
                    ...
                    <h2>An Increadible <span class="colorPrimary fontWeight400">Spa Experience</span></h2>
                    <p>
        ...
        <div  class="row">
            <div class="col-md-6">
                <div class="actionBox">
                    <h3>Clay Masks</h3>
                    <p>
                        A good clay mask can go a long way <br/>to draw out impurities skin.
                    </p>
                    <a href="shop.html" class="mo_btn"><i class="icofont-cart-alt"></i>Shop Now</a>
                </div>
            </div>
            <div class="col-md-6">
                <div class="actionBox abBg2">
                    ...
                    <a href="shop2.html" class="mo_btn"><i class="icofont-cart-alt"></i>Shop Now</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="serviceItem_01 sIlg text-center">
                    ...
                    <h3><a href="single-service.html">Candle Message</a></h3>
                    <p>
                        Risus commodo viverra maecenas accumsan lacus vel facilisis.
                    </p>
                </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="package_item pl_area">
                    <img src="{{asset('front/images/home_01/p1.jpg')}}" alt=""/>
                    <h5>
                ...
                <div class="package_item pl_area">
                    <img src="{{asset('front/images/home_01/p2.jpg')}}" alt=""/>
                    <h5>
                ...
                <div class="package_item pl_area">
                    <img src="{{asset('front/images/home_01/p3.jpg')}}" alt=""/>
                    <h5>
                ...
                <div class="package_item pl_area">
                    <img src="{{asset('front/images/home_01/p4.jpg')}}" alt=""/>
                    <h5>
            ...
            <div class="col-md-6">
                <div class="package_item pr_area">
                    <img src="{{asset('front/images/home_01/p5.jpg')}}" alt=""/>
                    <h5>
                ...
                <div class="package_item pr_area">
                    <img src="{{asset('front/images/home_01/p6.jpg')}}" alt=""/>
                    <h5>
                ...
                <div class="package_item pr_area">
                    <img src="{{asset('front/images/home_01/p7.jpg')}}" alt=""/>
                    <h5>
                ...
                <div class="package_item pr_area">
                    <img src="{{asset('front/images/home_01/p8.jpg')}}" alt=""/>
                    <h5>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="clientSlider owl-carousel">
                    <a href="javascript:void(0);"><img class="hover" src="{{asset('front/images/client_logo/1.png')}}" alt=""/><img class="normal" src="{{asset('front/images/client_logo/1.png')}}" alt=""/></a>
                    <a href="javascript:void(0);"><img class="hover" src="{{asset('front/images/client_logo/2.png')}}" alt=""/><img class="normal" src="{{asset('front/images/client_logo/2.png')}}" alt=""/></a>
                    <a href="javascript:void(0);"><img class="hover" src="{{asset('front/images/client_logo/3.png')}}" alt=""/><img class="normal" src="{{asset('front/images/client_logo/3.png')}}" alt=""/></a>
                    <a href="javascript:void(0);"><img class="hover" src="{{asset('front/images/client_logo/4.png')}}" alt=""/><img class="normal" src="{{asset('front/images/client_logo/4.png')}}" alt=""/></a>
                    <a href="javascript:void(0);"><img class="hover" src="{{asset('front/images/client_logo/5.png')}}" alt=""/><img class="normal" src="{{asset('front/images/client_logo/5.png')}}" alt=""/></a>
                    <a href="javascript:void(0);"><img class="hover" src="{{asset('front/images/client_logo/1.png')}}" alt=""/><img class="normal" src="{{asset('front/images/client_logo/1.png')}}" alt=""/></a>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="testimoanial_area">
                    <div class="tw_testiSlider">
                        <div class="item">
                            <div class="quote">
                                <img src="{{asset('front/images/home_01/quote.png')}}" alt=""/>
                    ...
                    <div class="testiNav">
                        <div class="navitem">
                            <img src="{{asset('front/images/home_01/t1.png')}}" alt=""/>
                        </div>
                        <div class="navitem">
                            <img src="{{asset('front/images/home_01/t2.png')}}" alt=""/>
                        </div>
                        <div class="navitem">
                            <img src="{{asset('front/images/home_01/t3.png')}}" alt=""/>
                        </div>
                        <div class="navitem">
                            <img src="{{asset('front/images/home_01/t1.png')}}" alt=""/>
                        </div>
...
<div class="my_instagram">
    <a href="{{asset('front/images/instagram/1.jpg')}}" data-rel="lightcase:myCollection:slideshow" class="popup_img"><img src="{{asset('front/images/instagram/1.jpg')}}" alt="instagram"></a>
    <a href="{{asset('front/images/instagram/2.jpg')}}" data-rel="lightcase:myCollection:slideshow" class="popup_img"><img src="{{asset('front/images/instagram/2.jpg')}}" alt="instagram"></a>
    <a href="{{asset('front/images/instagram/3.jpg')}}" data-rel="lightcase:myCollection:slideshow" class="popup_img"><img src="{{asset('front/images/instagram/3.jpg')}}" alt="instagram"></a>
    <a href="{{asset('front/images/instagram/4.jpg')}}" data-rel="lightcase:myCollection:slideshow" class="popup_img"><img src="{{asset('front/images/instagram/4.jpg')}}" alt="instagram"></a>
    <a href="{{asset('front/images/instagram/5.jpg')}}" data-rel="lightcase:myCollection:slideshow" class="popup_img"><img src="{{asset('front/images/instagram/5.jpg')}}" alt="instagram"></a>
    <a href="{{asset('front/images/instagram/6.jpg')}}" data-rel="lightcase:myCollection:slideshow" class="popup_img"><img src="{{asset('front/images/instagram/6.jpg')}}" alt="instagram"></a>
</div>
...
<footer class="footer_01">
    <div class="layer_img move_anim_two">
        <img src="{{asset('front/images/bg/footer.png')}}" alt=""/>
    </div>
    <div class="container">
        <div class="row">
